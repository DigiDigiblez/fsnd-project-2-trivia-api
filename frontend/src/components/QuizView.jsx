...
class QuizView extends Component {
    ...
    evaluateAnswer = () => {
        const formattedGuessArray = this.state.guess
            .replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, "")
            .toLowerCase()
            .split(" ");

        const formattedAnswerArray = this.state.currentQuestion.answer
            .replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, "")
            .toLowerCase()
            .split(" ");

        const match =
            JSON.stringify(formattedGuessArray) ===
            JSON.stringify(formattedAnswerArray);
